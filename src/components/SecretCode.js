          ...
          <div className="relative z-10 text-center space-y-8">
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-blue-500/50 text-sm"><span className="text-black/80">💡</span>Hint: The Date when I accepted your proposal (DDMMYYYY)</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <input
                ...
                className={`w-full px-6 py-4 bg-white/5 border-2 rounded-2xl text-center text-2xl font-semibold tracking-[0.5em] focus:outline-none focus:ring-4 transition-all ${
                  isWrong
                    ? "border-red-400/50 focus:ring-red-300/20 text-red-500"
                    : "border-white/20 focus:ring-pink-400/20 focus:border-pink-400/50 text-indigo-400"
                }`}
                placeholder="❤❤❤❤❤❤❤❤"
                maxLength={8}
              />
            ...
            {isWrong && (
              ...
              >
                💕Try again, my love! Think of our special date
              </motion.p>
            )}
          </div>
        </motion.div>
