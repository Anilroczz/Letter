    ...
    return (
        ...
        >
            ...
            <div className="text-center max-w-3xl mx-auto">
                ...
                >
                    <div className="w-40 h-40 mx-auto rounded-full bg-gradient-to-br from-purple-500/20 to-rose-500/20 flex items-center justify-center border-2 border-pink-400/30 pulse-glow">
                        <motion.div
                            transition={{
                                duration: 2,
                        ...
                        >
                            <img src="/assets/gif/cute.gif" className="" alt="panda jumping" />
                        </motion.div>
                    </div>
                </motion.div>

                <motion.h1
                    className="text-4xl md:text-6xl text-pink-500 mb-6 font-semibold leading-tight"
                ...
                {/* Subtitle */}
                <motion.p
                    className="text-purple-500/70 text-xl md:text-2xl mb-12"
